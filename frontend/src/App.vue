...
<template>
  <div class="min-h-screen">
    <header class="bg-[#24292f] text-white px-4 py-3 flex items-center gap-4">
      ...
      <template v-if="auth.isLoggedIn">
        <RouterLink v-if="auth.isAdmin" to="/admin/users" class="text-sm text-white/80 hover:text-white hover:no-underline">Users</RouterLink>
